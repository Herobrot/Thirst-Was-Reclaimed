...
public class CommonConfig
{
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> ENABLE_PURITY;
    ...
    static
    {
        ...
        ENABLE_PURITY = BUILDER.comment("Whether purity system is enabled. When disabled, no NBT purity tags will be added and no purity effects will apply").define("enablePurity", true);
        BUILDER.pop();
    ...
    public static void setup(FMLJavaModLoadingContext context)
    {
        ...
        context.registerConfig(ModConfig.Type.COMMON, SPEC, "thirst/common.toml");
    }
}
