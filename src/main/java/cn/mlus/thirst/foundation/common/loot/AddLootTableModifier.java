package cn.mlus.thirst.foundation.common.loot;
...
public class AddLootTableModifier extends LootModifier {
    public static final Supplier<Codec<AddLootTableModifier>> CODEC = Suppliers.memoize(() -> {
        return RecordCodecBuilder.create((inst) -> {
            return codecStart(inst).and(ResourceLocation.CODEC.fieldOf("lootTable").forGetter((m) -> {
                return m.lootTable;
    ...
    {
        if (!CommonConfig.ENABLE_LOOT.get())
